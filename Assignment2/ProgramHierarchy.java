...
/*
 * this program creates a diagram of class a hierarchy with GLabel, GRect, and GLine- straight forward except for positioning of objects, which is
 * relative (except for X_SPACING and Y_SPACING) so everything can be easily scaled by changing the named constants..
 */
