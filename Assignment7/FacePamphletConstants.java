...
public interface FacePamphletConstants {
	...
	public static final Font MESSAGE_FONT = new Font ("Dialog", Font.BOLD, 18);

	/** Name of font used to display the name in a user's profile */
	public static final Font PROFILE_NAME_FONT = new Font ("Dialog", Font.PLAIN, 24);
	...
	public static final Font PROFILE_STATUS_FONT = new Font ("Dialog", Font.BOLD, 16);

	/** Name of font used to display the label "Friends" above the
	 *  user's list of friends in a profile */
	public static final Font PROFILE_FRIEND_LABEL_FONT = new Font ("Dialog", Font.BOLD, 16);

	/** Name of font used to display the names from the user's list
	 *  of friends in a profile */
	public static final Font PROFILE_FRIEND_FONT = new Font ("Dialog", Font.PLAIN, 16);
	...
	public static final int BOTTOM_MESSAGE_MARGIN = 20;
